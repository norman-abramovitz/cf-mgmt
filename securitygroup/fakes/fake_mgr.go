...
type FakeManager struct {
	...
	ListDefaultSecurityGroupsStub        func() (map[string]*capi.SecurityGroup, error)
	...
	listDefaultSecurityGroupsReturns struct {
		result1 map[string]*capi.SecurityGroup
		result2 error
	}
	...
	ListNonDefaultSecurityGroupsStub        func() (map[string]*capi.SecurityGroup, error)
...
func (fake *FakeManager) ListDefaultSecurityGroups() (map[string]*capi.SecurityGroup, error) {
...
func (fake *FakeManager) ListDefaultSecurityGroupsCalls(stub func() (map[string]*capi.SecurityGroup, error)) {
	fake.listDefaultSecurityGroupsMutex.Lock()
	defer fake.listDefaultSecurityGroupsMutex.Unlock()
	fake.ListDefaultSecurityGroupsStub = stub
}

func (fake *FakeManager) ListDefaultSecurityGroupsReturns(result1 map[string]*capi.SecurityGroup, result2 error) {
	fake.listDefaultSecurityGroupsMutex.Lock()
	defer fake.listDefaultSecurityGroupsMutex.Unlock()
...
func (fake *FakeManager) ListDefaultSecurityGroupsReturnsOnCall(i int, result1 map[string]*capi.SecurityGroup, result2 error) {
	fake.listDefaultSecurityGroupsMutex.Lock()
	defer fake.listDefaultSecurityGroupsMutex.Unlock()
	fake.ListDefaultSecurityGroupsStub = nil
...
func (fake *FakeManager) ListNonDefaultSecurityGroups() (map[string]*capi.SecurityGroup, error) {
...
func (fake *FakeManager) ListNonDefaultSecurityGroupsCalls(stub func() (map[string]*capi.SecurityGroup, error)) {
	fake.listNonDefaultSecurityGroupsMutex.Lock()
	defer fake.listNonDefaultSecurityGroupsMutex.Unlock()
	fake.ListNonDefaultSecurityGroupsStub = stub
}

func (fake *FakeManager) ListNonDefaultSecurityGroupsReturns(result1 map[string]*capi.SecurityGroup, result2 error) {
	fake.listNonDefaultSecurityGroupsMutex.Lock()
	defer fake.listNonDefaultSecurityGroupsMutex.Unlock()
...
func (fake *FakeManager) ListNonDefaultSecurityGroupsReturnsOnCall(i int, result1 map[string]*capi.SecurityGroup, result2 error) {
	fake.listNonDefaultSecurityGroupsMutex.Lock()
	defer fake.listNonDefaultSecurityGroupsMutex.Unlock()
	fake.ListNonDefaultSecurityGroupsStub = nil
